...
public class SimpleDate {
    ...
    /*
        // A slightly not elegant solution to create enough unique
        // hashCode values based on given objects
        @Override
        public int hashCode() {
            Integer year = this.year;
            Integer month = this.month;
            Integer day = this.day;
            Integer hashCode = year.hashCode() * month.hashCode() * day.hashCode();
